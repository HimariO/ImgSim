...
class DistanceWeightedSampling(nn.Module):
    ...
    def forward(self, embedding, target):
        ...
        log_weights = (
            (2.0 - float(C)) * torch.log(distance) \
        ...
        return {
            'anchor_embeddings': embedding[a_indices],
...
class MarginLoss(nn.Module):
    ...
    def forward(self, anchor_embeddings, negative_embeddings, positive_embeddings, eps=1e-8, **kwargs):
        """
