...
from . import utils, folder
from .dino import DINOLoss, DataAugmentationDINO
...
def train_dino(args):
    ...
    dataset = folder.ImageFolder(args.data_path, transform=transform, max_samples=100_000)
    ...
    dino_loss = DINOLoss(
        args.out_dim,
        args.local_crops_number + 3,  # total number of crops = 2 global crops + local_crops_number
...
if __name__ == '__main__':
    ...
    main_dino.py --arch vit_small --data_path /path/to/imagenet/train --output_dir /path/to/saving_dir
    """
